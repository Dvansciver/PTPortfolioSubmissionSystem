<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PortfolioAdd.aspx.vb" Inherits="PTPortfolioSubmissionSystem.PortfolioAdd" %>
...
<asp:Table ID="tblMain" runat="server" Width="100%" HorizontalAlign="Center" CellPadding="1" CellSpacing="0">
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2">
            <asp:Label runat="server" Text="Add Portfolio" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
        </asp:TableCell>
    </asp:TableRow>
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            ...
            <asp:ListItem Value="1st" Text="1st" Selected="true" />
