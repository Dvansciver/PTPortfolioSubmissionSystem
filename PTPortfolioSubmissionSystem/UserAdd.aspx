<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UserAdd.aspx.vb" Inherits="PTPortfolioSubmissionSystem.UserAdd" %>
...
<asp:Table ID="tblMain" runat="server" Width="100%" HorizontalAlign="Center" CellPadding="1" CellSpacing="0">
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2">
            <asp:Label runat="server" Text="Add User" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
        </asp:TableCell>
    </asp:TableRow>
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            <asp:DropDownList runat="server" ID="ddlUserType" AutoPostBack="true" CausesValidation="false">
    ...
    <asp:TableRow>
        <asp:TableCell HorizontalAlign="Right">
            <asp:Button runat="server" ID="btnSubmit" Text="Submit" ValidationGroup="grpUser" />&nbsp;
        </asp:TableCell>
        <asp:TableCell>
